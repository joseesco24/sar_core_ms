...
@mark.asyncio
async def test_driver_search_waste_by_status_1() -> None:
    waste_core._parameter_core.cpm_pc_get_set_of_parameter_ids_by_domain = AsyncMock(return_value=set([9]))  # type: ignore
