...
collect_request_controller.collect_request_provider.store_collect_request = MagicMock(return_value=collect_request_uuid_fixture_1)
collect_request_controller.parameter_provider.search_parameters_by_domain = MagicMock(return_value=parameter_list_fixture_1)
collect_request_controller.waste_provider.store_waste = MagicMock(side_effect=wastes_ids_fixture_1)
collect_request_controller.collect_request_provider.search_collect_request_by_id = MagicMock(return_value=collect_request)
...
async def test_validate_wastes_domains_1() -> None:
    try:
        await collect_request_controller._validate_wastes_domains(request_create_request=request_create_request_fixture_1)
...
async def test_store_collect_request_1() -> None:
    collect_request_id: str = await collect_request_controller._store_collect_request(request_create_request=request_create_request_fixture_1)
    assert collect_request_id == collect_request_uuid_fixture_1
    collect_request_controller.collect_request_provider.store_collect_request.assert_called_with(
...
async def test_store_collect_request_wastes_1() -> None:
    wastes_ids: list[str] = await collect_request_controller._store_collect_request_wastes(
    ...
    collect_request_controller.waste_provider.store_waste.assert_has_calls(calls)


@mark.asyncio
async def test_search_collect_request_by_id_1() -> None:
    await collect_request_controller._search_collect_request_by_id(collect_request_id=collect_request_uuid_fixture_1)
    collect_request_controller.collect_request_provider.search_collect_request_by_id.assert_called_with(uuid=collect_request_uuid_fixture_1)


@mark.asyncio
async def test_search_wastes_by_ids_1() -> None:
    await collect_request_controller._search_wastes_by_ids(wastes_ids=wastes_ids_fixture_1)
    calls = [
        call(uuid=wastes_ids_fixture_1[0]),
        call(uuid=wastes_ids_fixture_1[1]),
    ]
    collect_request_controller.waste_provider.search_waste_by_id.assert_has_calls(calls)


@mark.asyncio
async def test_map_collect_response_1() -> None:
    request_create_response: CollectRequestCreateResponseDto = await collect_request_controller._map_collect_response(collect_request_info=collect_request, wastes_info=wastes_list)
